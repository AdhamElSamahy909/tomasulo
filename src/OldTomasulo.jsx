...
//   // Custom Init for the Loop Trace
//   regs["R1"].val = 32;
//   regs["R2"].val = 0;
//   regs["F2"].val = 0.5;
...
//       qj: null,
//       qk: null,
//       address: null, // Holds Offset initially, then Effective Addr
//       timer: 0,
//       state: "IDLE",
//       instIdx: -1,
//       result: 0,
...
//       // Priority: Branch > Store > Load > ALU
//       writeCandidates.sort((a, b) => {
//         const priority = { BRANCH: 4, STORE: 3, LOAD: 2, MULT: 1, ADD: 0 };

//         // Primary Sort: Dependent Count (Approximated by scanning other RS)
//         let depA = 0,
//           depB = 0;
//         // Scan RS to see who is waiting for A or B
//         Object.values(next.rs)
//           .flat()
//           .forEach((other) => {
...
//         if (depA !== depB) return depB - depA; // Higher dep first
//         return priority[b.type] - priority[a.type]; // Fallback to Type
//       });
...
//             // u.address held Offset. u.vj holds Base.
//             // Effective Addr = Base + Offset
//             u.address = (u.vj || 0) + (u.address || 0);
//           }

//           // --- CACHE ACCESS LOGIC (Loads Only) ---
//           if (u.type === "LOAD") {
//             const addr = u.address;
//             const blockIdxRaw = Math.floor(addr / next.config.cache.blockSize);

//             // Ensure positive modulo for array index
...
//             // CALCULATE RESULTS
//             if (u.type === "LOAD") {
//               // Align to word/double word boundary logic if needed, simple map lookup here
//               u.result =
...
//           next.stalledPc = next.pc; // Stall PC
//         } else {
//           // Execute immediately (No RS)
//           const val1 = r1.val;
//           const val2 = r2.val;
//           let taken = false;
...
//             freeUnit.address = offset; // Store offset temporarily
...
//               <span className="text-pink-400 animate-pulse">Wait</span>
//             ) : (
//               ""
//             )}
//           </td>
